...
class CaptureArea:
    ...
    def create_window(self):
        self.top = tk.Toplevel(self.master, bg='gray')
    ...
    def on_mouse_release(self, event):
        ...
        self.settings.update_coordinates_display(self.start_x, self.start_y, self.end_x, self.end_y)  # Corrected method name

    def save_capture_area(self, x1, y1, x2, y2):
        self.settings.config['Settings']['CaptureCoordinates'] = f'{x1}, {y1}, {x2}, {y2}'
        with open(self.settings.config_file, 'w') as configfile:
